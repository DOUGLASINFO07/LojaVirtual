...
$codigo_transacao = Rotas::$pag[1];
$referencia = Rotas::$pag[2];

//$pag->codigoTransacao($ref);
// pega a transação por REF apos ter efetuado a compra
$pag->BuscarTransacaoREF($codigo_transacao, $referencia);
...
$smarty->display('view/pedido_retorno.tpl');
