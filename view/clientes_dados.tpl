...
<form name="cadcliente" id="cadcliente" method="post" action="">
    <section class="row" id="cadastro">
        ...
        <div class="col-md-2">
            <label>CPF:</label>
            <input type="text" value="{$CLIENTES_CPF}" name="clientes_cpf" class="form-control" minlength="11" maxlength="11" required readonly>
        </div>
        <div class="col-md-2">
            <label>DDD:</label>
    ...
    <section class="row" id="btngravar">
        ...
        <div class="col-md-4">
            ...
            <input type="password" name="clientes_senha" id="clientes_senha" class="form-control" required>
            <br>
