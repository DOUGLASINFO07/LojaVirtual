    ...
    <section class="row" id="fazerlogin">
        <form name="cliente_login" method="post" action="" >
            ...
            <div class="col-md-4">
                ...
                <div class="form-group"> 
                    <a href="{$PAG_CADASTRO}" class="btn btn-danger "><i class="glyphicon glyphicon-pencil"></i> Me Cadastrar</a>
                    <a href="{$PAG_RECOVERY}" class="btn btn-danger "><i class="glyphicon glyphicon-question-sign"></i> Esqueci a Senha</a>
                </div>
            </div><!-- fim dos campos --->
            <div class="col-md-4 text-center"> 
            </div>
